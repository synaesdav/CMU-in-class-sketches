...
//operating multiple digits
//counts 00 - 99 to test bitmap appearance
...
void loop()
{
  whichNumber(firstNumber, 4, 0);//calls the function with the parameters of number, X axis location, Y axis location
  whichNumber(secondNumber, 0, 0);
  ...
  firstNumber++;//advance the number, reset to 0 after 9
  if (firstNumber > 9)
  {
    firstNumber = 0;
    secondNumber++;
